...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
 ...
 <script type="text/javascript" src="<c:url value="/scripts/supersized/slideshow/js/supersized.3.2.7.min.js"/>"></script>
 <script type="text/javascript" src="<c:url value="/scripts/supersized/slideshow/js/jquery.easing.min.js"/>"></script>
 <script type="text/javascript" src="<c:url value="/scripts/supersized/slideshow/js/supersized.3.2.7.min.js"/>"></script>
 <script type="text/javascript" src="<c:url value="/scripts/supersized/slideshow/theme/supersized.shutter.min.js"/>"></script>
 
 
 <link rel="stylesheet" href="<c:url value="/scripts/supersized/slideshow/css/supersized.css"/>" type="text/css" media="screen" />
 <link rel="stylesheet" href="<c:url value="/scripts/supersized/slideshow/theme/supersized.shutter.css"/>" type="text/css" media="screen" />
</head>
<body class="live">
...
$(document).ready(function()
  {
	$.supersized({
		...
		new_window: 0,
		slides  :  	[  <c:forEach var="installation" items="${installations}" varStatus="count">
						{image : '<c:url value="/${installation.link}"/>', title: "${installation.title}"}
							<c:if test="${count.count < fn:length(installations)}">
							,
							</c:if>
						</c:forEach>
					]
